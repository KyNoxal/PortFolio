    ...
    <main className="mb-4 bg-wheat w-full justify-center min-h-screen">
      ...
      <Card
        ...
        nodes={
          <div>
            <p>
              Recherche Futée est une application web développée en PHP sans
              framework. Il provient d&apos;une observation du comité de
              direction de ma formation (BUT Informatique) lorsqu&apos;il
              s&apos;agit de l’organisation des étudiants dans leurs recherches
              de stages et d’alternance.
              <br />
              <br />
              Recherche Futé propose une organisation basée sur les candidatures
              de l&apos;utilisateur. Il permet d&apos;enregistrer toutes les
              informations relatives aux offres et, par la suite, permet
              également de trier ses candidatures.
              <br />
              <br />
              Enfin, recherche futée propose à l&apos;utilisateur des
              statistiques basée sur ses candidatures, comme le nombre de
              candidatures refusées, en attente, etc.
            </p>
          </div>
        }
      />
      ...
      <Card
        ...
        nodes={
          <div>
            <p>
              Ce projet a été mené en équipe de 5 personnes dans le cadre de la
              fin de deuxième année de mon BUT Informatique
            </p>
            <br></br>
            <p>
              Il a donc pour but de valider le troisième semestre de
              l&apos;année du BUT Informatique en vérifiant la bonne application
              des notions si-dessous :
            </p>
            <ul className="list-disc ml-4">
